...
import useFranchiseOverviewData from "./useFranchiseOverviewData";
...
const FranchiseOverview = () => {
  ...
  // Precompute per-row derived data (status lookup, sorting/print flags, badge
  // color, department pills) for every visible patient so this isn't
  // recalculated on every render (e.g. hovering a print icon, opening a
  // modal) that doesn't actually change filteredPatients or statuses.
