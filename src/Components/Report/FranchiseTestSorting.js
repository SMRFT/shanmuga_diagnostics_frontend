...
const handlePrint = async (withLetterpad) => {
 ...
 currentYPosition += 10; // Add extra space between patient info and table
 ...
 // Replace the section that renders tests (starting from "Object.keys(testsByDepartment).forEach")
