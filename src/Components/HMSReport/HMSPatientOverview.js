...
const HMSPatientOverview = () => {
  ...
  const handleWhatsAppShare = async (patient) => {
    ...
    try {
      ...
      // Upload PDF file using apiRequest
      ...
      if (!uploadResponse.success) {
        toast.error(`File upload failed: ${uploadResponse.error}`);
      ...
      const labName = "Shanmuga Diagnostic";
      const labPhone = "+91 98765 43210";
      const address = "24, Saratha Clg Rd, Salem, PIN-636007";
      const footerNote = "_For any queries, please contact our lab._";
